/*=========================================================================
  ...
  Module:    TestPolyDataBooleanFilter.cxx
...
static vtkActor* GetBooleanOperationActor( double x, int operation )
{
  ...
  vtkSmartPointer<vtkPolyDataBooleanFilter> boolFilter =
    vtkSmartPointer<vtkPolyDataBooleanFilter>::New();
...
int TestPolyDataBooleanFilter(int, char *[])
{
  ...
  vtkActor *unionActor =
    GetBooleanOperationActor( -2.0, vtkPolyDataBooleanFilter::VTK_UNION );
  renderer->AddActor( unionActor );
  unionActor->Delete();

  vtkActor *intersectionActor =
    GetBooleanOperationActor(  0.0, vtkPolyDataBooleanFilter::VTK_INTERSECTION );
  renderer->AddActor( intersectionActor );
  intersectionActor->Delete();

  vtkActor *differenceActor =
    GetBooleanOperationActor(  2.0, vtkPolyDataBooleanFilter::VTK_DIFFERENCE );
